...
const About = () => {
  const Content =
  <div className="p-2 w-full">
It's a youtube video downloader website
All credit goes to our
MEMBERS:
Muhammad Ali Abbas
Abdullah kareem
Zain ALi
...
const Credits = () => {
  const Content =
  <div className="p-2 w-full">
It was a group project so we would like to thanks 
all of our members for helping us with it and also sir Sohaib
for encouraging us.
</div>
  return (
    <Tab 
